...
| M09 SQL 工作台 P2 受控 CRUD | 启动中 | 5% | 已接受 ADR 0009，确认语义执行轨道、Notebook 式独立结果、`dev` / `sit` / `uat` 受控 CRUD、生产只读、DML 影响预览、无 WHERE 二次确认、短事务、服务端策略、持久化工作流、Worker 二次校验和审计边界 | 完成会话与单元契约、DML 影响预览、环境风险策略、受限写 Worker、短事务执行、审计事件、安全评审和 E2E 验收 |
